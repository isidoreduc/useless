...
namespace API
{
  public class Startup
  {
    ...
    // convention-based functionality: if the method is called precisely this way, services inside will be injected
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      ...
      app.UseStaticFiles(new StaticFileOptions
      {
        FileProvider = new PhysicalFileProvider(
            Path.Combine(Directory.GetCurrentDirectory(), "SiteContent")),
        RequestPath = "/content"
      });
